...
extern uint8_t write(addr_t start_addr, size_of_op_t op_size);
extern uint8_t read(addr_t start_addr, size_of_op_t op_size);
// 退出程序
extern void reset(reset_type_t type);
